...
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { led[11] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]d
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { term }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]d
